...
async def stepVolunteerId(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.answer('Введите id волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
    await call.answer()
...
async def stepVolunteerFirstName(message: Message, state: FSMContext):
    ...
    await message.answer('Введите имя волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
...
async def stepVolunteerLastName(message: Message, state: FSMContext):
    ...
    await message.answer('Введите фамилию волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
...
async def stepVolunteerGetPhone(message: Message, state: FSMContext):
    ...
    await message.answer('Введите телефон волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
...
async def stepVolunteerGetPhone(message: Message, state: FSMContext):
    ...
    await message.answer('Введите email волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
...
async def stepVolunteerGetPhone(message: Message, state: FSMContext):
    ...
    await message.answer('Введите фотографию волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
...
async def stepVolunteerGetPhone(message: Message, state: FSMContext):
    ...
    await message.answer('Пришлите, сколько кг корма на руках у волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
...
async def stepVolunteerGetPhone(message: Message, state: FSMContext):
    ...
    await message.answer('Пришлите пасспорт волонтера', reply_markup=gеtGoSettingsAdminKeykeyboard())
